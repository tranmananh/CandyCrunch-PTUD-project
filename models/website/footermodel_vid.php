<?php
// app/models/FooterVideoModel.php 

class FooterVideoModel {
    
    /**
     * Lấy dữ liệu cho phần Video và Overlay.
     * @return array
     */
    public static function getVideoData(): array {
        return [
            'video_src' => 'views/img/footervideo.mp4',
            'video_type' => 'video/mp4',
            'no_support_text' => 'Your browser does not support the video tag.'
        ];
    }
