<?php
// header có icon cho cart/wishlist/account pages
class HeaderModel {
     ...
     * @return array
     */
    public static function getPrimaryLinks() {
        return [
    ...
    /**
     * Lấy dữ liệu cho User Actions (Cart/Wishlist/Account).
     * @param int $cartCount Số lượng sản phẩm thực tế trong giỏ hàng (được truyền từ Controller).
     * @return array
     */
    public static function getUserActionsData(int $cartCount = 0): array {
        return [
            'cart' => [
                'url' => 'cart.php', 
                'icon' => 'views/img/cart.svg', 
                'text' => "Cart ({$cartCount})",
                'alt' => 'Cart'
            ],
            'wishlist' => [
                'url' => 'wishlist.php', 
                'icon' => 'views/img/wishlist.svg', 
                'text' => 'Wishlist',
                'alt' => 'Wishlist'
            ],
            'account' => [
                'url' => 'account.php', 
                'icon' => 'views/img/person.svg', 
                'text' => 'Account',
                'alt' => 'User'
            ],
        ];
    ...
    public static function getShopDropdownData(): array {
        return [
            ...
            // Dữ liệu Card Sản phẩm nổi bật mặc định
            'featured' => [
